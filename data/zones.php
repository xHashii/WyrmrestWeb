<?php
/**
 * Zone ID => name lookup, generated from an AreaTable export (3.4.3).
 * Used by the "Who's Online" list to show a readable zone name
 * instead of the raw characters.zone number.
 */
return [
    1 => 'Dun Morogh',
    2 => 'Longshore',
